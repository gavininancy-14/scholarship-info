...
<body>
    <header class="d-flex justify-content-between align-items-center p-3 bg-white shadow-sm">
        <div class="logo text-primary fs-4 fw-bold">StudySponsor</div>
        <nav>
            <ul class="nav">
                <li class="nav-item"><a class="nav-link text-dark" href="students.php">Students</a></li>
                <li class="nav-item"><a class="nav-link text-dark" href="parents/parent.php">Parents</a></li>
            </ul>
        </nav>
        <div>
            <button class="btn btn-success"><a href="login.php">Student Login</a></button>
        </div>
